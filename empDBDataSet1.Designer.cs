...
namespace MultiplexManagementSystem {
    ...
    public partial class empDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeesRow AddEmployeesRow(string First_Name, string Last_Name, string Email, string Address, byte[] Image, string Salary) {
...
namespace MultiplexManagementSystem.empDBDataSet1TableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Employees` WHERE ((`ID` = ?) AND ((? = 1 AND `First Name` IS NULL) OR (`First Name` = ?)) AND ((? = 1 AND `Last Name` IS NULL) OR (`Last Name` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)) AND ((? = 1 AND `Salary` IS NULL) OR (`Salary` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Employees` (`First Name`, `Last Name`, `Email`, `Address`, `Image`, " +
                "`Salary`) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Employees` SET `First Name` = ?, `Last Name` = ?, `Email` = ?, `Address` = ?, `Image` = ?, `Salary` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `First Name` IS NULL) OR (`First Name` = ?)) AND ((? = 1 AND `Last Name` IS NULL) OR (`Last Name` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)) AND ((? = 1 AND `Salary` IS NULL) OR (`Salary` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MultiplexManagementSystem.Properties.Settings.Default.Database2ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, [First Name], [Last Name], Email, Address, [Image], Salary FROM Employ" +
                "ees";
        ...
        public virtual int Fill(empDBDataSet1.EmployeesDataTable dataTable) {
        ...
        public virtual empDBDataSet1.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            empDBDataSet1.EmployeesDataTable dataTable = new empDBDataSet1.EmployeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(empDBDataSet1.EmployeesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_First_Name, string Original_Last_Name, string Original_Email, string Original_Address, string Original_Salary) {
        ...
        public virtual int Insert(string First_Name, string Last_Name, string Email, string Address, byte[] Image, string Salary) {
            if ((First_Name == null)) {
        ...
        public virtual int Update(string First_Name, string Last_Name, string Email, string Address, byte[] Image, string Salary, int Original_ID, string Original_First_Name, string Original_Last_Name, string Original_Email, string Original_Address, string Original_Salary) {
            if ((First_Name == null)) {
