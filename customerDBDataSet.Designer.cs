...
namespace MultiplexManagementSystem {
    ...
    public partial class customerDBDataSet : global::System.Data.DataSet {
        ...
        public partial class custDataTable : global::System.Data.TypedTableBase<custRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public custRow AddcustRow(string name, string email, string contact, string paymentType) {
        ...
        public partial class custRow : global::System.Data.DataRow {
            ...
            public string contact {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'contact\' in table \'cust\' is DBNull.", e);
                    }
                }
                set {
            ...
            public string paymentType {
                get {
                    try {
                        return ((string)(this[this.tablecust.paymentTypeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'paymentType\' in table \'cust\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablecust.paymentTypeColumn] = value;
                }
            }
            ...
            public bool IscontactNull() {
                return this.IsNull(this.tablecust.contactColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetcontactNull() {
                this[this.tablecust.contactColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public bool IspaymentTypeNull() {
                return this.IsNull(this.tablecust.paymentTypeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetpaymentTypeNull() {
                this[this.tablecust.paymentTypeColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace MultiplexManagementSystem.customerDBDataSetTableAdapters {
    ...
    public partial class custTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `cust` WHERE ((`ID` = ?) AND ((? = 1 AND `name` IS NULL) OR (`name` =" +
                " ?)) AND ((? = 1 AND `email` IS NULL) OR (`email` = ?)) AND ((? = 1 AND `contact" +
                "` IS NULL) OR (`contact` = ?)) AND ((? = 1 AND `paymentType` IS NULL) OR (`payme" +
                "ntType` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `cust` (`name`, `email`, `contact`, `paymentType`) VALUES (?, ?, ?, ?" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `cust` SET `name` = ?, `email` = ?, `contact` = ?, `paymentType` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `name` IS NULL) OR (`name` = ?)) AND ((? = 1 AND `email` IS NULL) OR (`email` = ?)) AND ((? = 1 AND `contact` IS NULL) OR (`contact` = ?)) AND ((? = 1 AND `paymentType` IS NULL) OR (`paymentType` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MultiplexManagementSystem.Properties.Settings.Default.customerDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, name, email, contact, paymentType FROM cust";
        ...
        public virtual int Fill(customerDBDataSet.custDataTable dataTable) {
        ...
        public virtual customerDBDataSet.custDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            customerDBDataSet.custDataTable dataTable = new customerDBDataSet.custDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(customerDBDataSet.custDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_name, string Original_email, string Original_contact, string Original_paymentType) {
        ...
        public virtual int Insert(string name, string email, string contact, string paymentType) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string email, string contact, string paymentType, int Original_ID, string Original_name, string Original_email, string Original_contact, string Original_paymentType) {
            if ((name == null)) {
